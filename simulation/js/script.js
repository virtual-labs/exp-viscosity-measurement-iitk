var hmessage=[
"उपकरणों पर माउस ले जा कर उनसे स्वयं को परिचित कराएं.....फिर प्रयोग शुरू करने के लिए स्टार्ट बटन पर क्लिक करें।",
...
"10 मिलीलीटर आसुत जल लेने के लिए पिपेट पर क्लिक करें।",
"इसे खाली फ्लास्क में डालें।",
"50% चीनी सांद्रित घोल का 40 मिलीलीटर लेने के लिए पिपेट पर क्लिक करें।",
"इस चीनी के घोल को आसुत जल वाले फ्लास्क में मिलाएं।",
"बहुत बढ़िया!\nआपका 40% चीनी सांद्रित घोल तैयार है। अब पिपेट धो लें और\n\n30 मिलीलीटर आसुत जल लेने के लिए पिपेट पर क्लिक करें।",
"इसे खाली फ्लास्क में डालें।",
"50% चीनी सांद्रित घोल का 20 मिलीलीटर लेने के लिए पिपेट पर क्लिक करें।",
"इस चीनी के घोल को आसुत जल वाले फ्लास्क में मिलाएं।",
"बहुत बढ़िया!\nआपका 20% चीनी सांद्रित घोल तैयार है। अब पिपेट धो लें और\n\n40 मिलीलीटर आसुत जल लेने के लिए पिपेट पर क्लिक करें।",
"इसे खाली फ्लास्क में डालें।",
"50% चीनी सांद्रित घोल का 10 मिलीलीटर लेने के लिए पिपेट पर क्लिक करें।",
"इस चीनी के घोल को आसुत जल वाले फ्लास्क में मिलाएं।",
"बहुत बढ़िया!\nआपका 10% चीनी सांद्रित घोल तैयार है। अब पिपेट धो लें और\n\n45 मिलीलीटर आसुत जल लेने के लिए पिपेट पर क्लिक करें।",
"इसे खाली फ्लास्क में डालें।",
"50% चीनी सांद्रित घोल का 5 मिलीलीटर लेने के लिए पिपेट पर क्लिक करें।",
"इस चीनी के घोल को आसुत जल वाले फ्लास्क में मिलाएं।",
"बहुत बढ़िया!\nआपका 5% चीनी सांद्रित घोल तैयार है।\n\nअब, नेक्स्ट बटन पर क्लिक करके प्रयोग के अगले चरण पर जाएँ।",

"वजन मापने की मशीन चालू करें।",
"खाली पिकनोमीटर (शंक्वाकार फ्लास्क के बगल में) को वजन मापने की मशीन पर रखें और उसका वजन नोट कर लें।",
"अब, खाली पिकनोमीटर को वापस मेज पर रख दें।",
"पिपेट का उपयोग करके, पर्याप्त मात्रा में आसुत जल लें।",
"पानी को खाली पिकनोमीटर में डालें।",
"फिर से पिपेट का उपयोग करके, 50% चीनी सांद्रित घोल की पर्याप्त मात्रा लें।",
"घोल को खाली पिकनोमीटर में डालें।",
"पिपेट को वापस उसकी जगह पर रख दें।",
"पानी से भरे पिकनोमीटर को वजन मापने वाली मशीन पर रखें और उसका वजन नोट कर लें।",
"अब, पानी से भरे पिकनोमीटर को वापस मेज पर रख दें।",
"चीनी के घोल से भरे पिकनोमीटर को वजन मापने वाली मशीन पर रखें और उसका वजन नोट कर लें।",
"अब, चीनी के घोल से भरे पिकनोमीटर को वापस मेज पर रख दें।",
"अब पिपेट को धो लें और, 40% चीनी सांद्रित घोल की पर्याप्त मात्रा लें।",
"घोल को खाली पिकनोमीटर में डालें।",
"पिपेट को वापस उसकी जगह पर रख दें।",
"चीनी के घोल से भरे पिकनोमीटर को वजन मापने वाली मशीन पर रखें और उसका वजन नोट कर लें।",
"अब, चीनी के घोल से भरे पिकनोमीटर को वापस मेज पर रख दें। और 20%, 10% और 5% घोलों के लिए चरणों को दोहराएँ।",

"पिपेट को धो लें और फिर दिए गए अज्ञात चीनी सांद्रित घोल की पर्याप्त मात्रा लें।",
"घोल को खाली पिकनोमीटर में डालें।",
"पिपेट को वापस उसकी जगह पर रख दें।",
"चीनी के घोल से भरे पिकनोमीटर को वजन मापने वाली मशीन पर रखें और उसका वजन नोट कर लें।",
"अब, चीनी के घोल से भरे पिकनोमीटर को वापस मेज पर रख दें।",
...
"पिपेट का उपयोग करके, पर्याप्त मात्रा में आसुत जल लें।",
"इस घोल को विस्कोमीटर में मार्क C तक डालें।",
"विस्कोमीटर के दूसरी तरफ से, पाइप के अंत में लगे विस्कोमीटर के सक्शन नॉब (लाल रंग का) का उपयोग करके चीनी के घोल को खींचें।",
"घोल को और ऊपर उठाने के लिए सक्शन नॉब (लाल रंग का) दबाएँ।",
"अच्छा! अब, चीनी के घोल को स्वतंत्र रूप से गिरने देने के लिए सक्शन नॉब (लाल रंग का) को दबाकर छोड़ दें।\n\n घोल के मार्क B तक पहुँचने तक कुछ देर प्रतीक्षा करें।",
"अंतिम परिणाम प्राप्त करने के लिए फॉरवर्ड बटन पर क्लिक करें।",
"चीनी के घोल को मार्क A से मार्क B तक पहुँचने में लगे समय को नोट करें और रीसेट बटन पर क्लिक करें।\n\n उसके बाद, नेक्स्ट बटन पर क्लिक करें।",

"पिपेट का उपयोग करके, 5% चीनी सांद्रित घोल की पर्याप्त मात्रा लें।",
"इस घोल को विस्कोमीटर में मार्क C तक डालें।",
"विस्कोमीटर के दूसरी तरफ से, पाइप के अंत में लगे विस्कोमीटर के सक्शन नॉब (लाल रंग का) का उपयोग करके चीनी के घोल को खींचें।",
"घोल को और ऊपर उठाने के लिए सक्शन नॉब (लाल रंग का) दबाएँ।",
"अच्छा! अब, चीनी के घोल को स्वतंत्र रूप से गिरने देने के लिए सक्शन नॉब (लाल रंग का) को दबाकर छोड़ दें।\n\n घोल के मार्क B तक पहुँचने तक कुछ देर प्रतीक्षा करें।",
...
function speech1(){
    ...
    if(lang === "none"){
        return; // No language selected, so do nothing
    }

    let mes1;
    if(lang === "hindi"){
        mes1 = hmessage[messcounter - 1]; // Use messcounter - 1 as update increments it first
    } else if(lang === "eng"){
        mes1 = message[messcounter - 1]; // Use messcounter - 1 as update increments it first
    }

    // Ensure there's a message to speak
    if (mes1) {
        setTimeout(function(){
        ...
        }, 100); // A small delay to ensure cancelation takes effect and new speech starts smoothly
    }
}
...
function update(){
    ...
    // Increment messcounter AFTER setting mes.innerText so speech1 gets the correct index
    messcounter += 1; 
    
    speech1(); // Call speech1 to speak the *new* instruction
}

// Keep your existing hindi1 and eng1 functions as they are
function hindi1(){
    lang = "hindi";
    langselector.style.opacity = "0%";
    ins.innerText = "निर्देश :-"; // This seems to be a fixed instruction label

    setTimeout(function(){
        langselector.style.visibility = "hidden";
    }, 1000);
    update(); // Start the first instruction update
}
